...
namespace App\Http\Controllers\Home\FundProjects\GirlsHostel;
...
class FundaProjectgirlsHostel extends Controller
{
    ...
    {
        return view('pages.Home.FundProjects.GirlsHostel.index');
    }
  ...
  public function store(Request $request)
{
    ...
    // Folder path
    $uploadPath = public_path('uploads/fund-Project/girls-Hostel');
    ...
    // Save record
    GirlsHostelCostEstimate::create([
