...
namespace App\Http\Controllers\Home\FundProjects\BoysHostel;
...
class FundaProjectBoysHostel extends Controller
{
    ...
    {
        return view('pages.Home.FundProjects.BoysHostel.index');
    }
  ...
  public function store(Request $request)
{
    ...
    // Folder path
    $uploadPath = public_path('uploads/fund-Project/Boys-Hostel');
