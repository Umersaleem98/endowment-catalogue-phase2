...
namespace App\Http\Controllers\Home\FundProjects\Business;
...
class FundaProjectBusinessCenter extends Controller
{
    ...
    {
        return view('pages.Home.FundProjects.Business.index');
    }
  ...
  public function store(Request $request)
{
    ...
    // Folder path
    $uploadPath = public_path('uploads/fund-Project/Business-center');
