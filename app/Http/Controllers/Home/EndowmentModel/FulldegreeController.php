...
class FulldegreeController extends Controller
{
     public function index()
    {
        ...
        return view('pages.Home.EndowmentModels.FourYear.FourYearEndoementFund', compact('countries', 'schools', 'postgraduate', 'undergraduate'));
    }
    ...
    public function DefultFourYearundergraduate(Request $request)
    {
        ...
        if ($request->hasFile('prove')) {
            ...
            $destination = public_path('uploads/fulldegree-proof');
