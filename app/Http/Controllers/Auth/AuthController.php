...
class AuthController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Group Hostel Payments by Type (Optional)
        $hostelPaymentsByType = HostelPayment::select('payment_type', \DB::raw('COUNT(*) as count'))
        ...
        $scholarshipCounts = Student::select('scholarship_name', \DB::raw('COUNT(*) as count'))
            ...
            return view('dashboard', compact(
                ...
                'ugStudentsByYear', 'pgStudentsByYear', 'allYears', 'scholarshipCounts',
                'totalHostelPayments', 'hostelPaymentsByType'
            ));
    }
}
