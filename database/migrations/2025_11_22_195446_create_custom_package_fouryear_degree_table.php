...
return new class extends Migration
{
    ...
    {
        Schema::create('custom_package_fouryear_degree', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('payments_status')->default('pending'); 
    ...
    {
        Schema::dropIfExists('custom_package_fouryear_degree');
    }
};
