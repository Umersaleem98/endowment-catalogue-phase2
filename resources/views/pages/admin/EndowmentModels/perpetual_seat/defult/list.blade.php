<title>Perpetual Seat Endowment List</title>
                        ...
                        <div class="row gy-6">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <!-- BULK DELETE FORM -->
                                    <form action="{{ route('perpetualseat.bulk.delete') }}" method="POST"
                                        id="bulkDeleteForm">
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive text-nowrap">
                                                <table
                                                    ...
                                                    <tbody>
                                                        @forelse ($perpetual_seat as $index => $item)
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>{{ $perpetual_seat->firstItem() + $index }}</td>
                                                                ...
                                                                <td>
                                                                    @if ($item->prove)
                                                                        <a href="{{ asset('uploads/perpetualseat-proof/' . $item->prove) }}"
                                                                            target="_blank"
                                                        ...
                                                        @empty
                                                            <tr>
                                                                <td colspan="16" class="text-center">No records found.
                                                                </td>
                                                            </tr>
                                                        @endforelse
                                                    </tbody>
