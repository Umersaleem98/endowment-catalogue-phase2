...
<body>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('students.import') }}" method="POST"
                                            enctype="multipart/form-data" class="d-flex mb-3">
                                            @csrf
                                            <input type="file" name="file" class="form-control form-control-sm"
                                                required>
                                            <button type="submit" class="btn btn-success btn-sm ms-2">Import
                                                Excel</button>
                                        </form>
                                                    ...
                                                    <tbody>
                                                        @forelse ($students as $index => $student)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('students.adopted', $student->id) }}"
                                                                        class="btn btn-success btn-sm">
                                                                        Adopted
                                                                    </a>
                                                                </td>
                                                                <td>
                                                                    <a href="{{ route('students.adopted.hostel', $student->id) }}"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // On form submit, verify at least one selected
