<title>Mosque Payment List</title>
                                ...
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="card-title mb-0">
                                            Mosque Cost Estimate List
                                            <span class="badge bg-primary ms-2">{{ $mosques->total() }}</span>
                                        </h5>

                                        <form method="GET" action="{{ route('fundproject.mosque') }}"
                                            ...
                                            <a href="{{ route('fundproject.mosque') }}"
                                    ...
                                    <div class="card-body table-responsive">
                                        <table class="table table-striped table-hover table-sm align-middle">
                                            ...
                                            <tbody>
                                                @forelse($mosques as $index => $item)
                                                    <tr>
                                                        <td>{{ $mosques->firstItem() + $index }}</td>
                                                        ...
                                                        <td>
                                                            @if ($item->prove)
                                                                <img src="{{ asset('uploads/fund-Project/Mosque/' . $item->prove) }}"
