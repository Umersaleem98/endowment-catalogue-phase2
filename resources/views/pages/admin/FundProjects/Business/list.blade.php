<title>businessCenter Payment List</title>
                                ...
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="card-title mb-0">
                                            Business Center Cost Estimate
                                            List
                                            <span class="badge bg-primary ms-2">{{ $business->total() }}</span>
                                        </h5>

                                        <form method="GET" action="{{ route('fundproject.businessCenter') }}"
                                            ...
                                            <a href="{{ route('fundproject.businessCenter') }}"
                                        ...
                                        <table class="table table-striped table-hover table-sm align-middle">
                                            ...
                                            <tbody>
                                                @forelse($business as $index => $item)
                                                    <tr>
                                                        <td>{{ $business->firstItem() + $index }}</td>
                                                        ...
                                                        <td>
                                                            @if ($item->prove)
                                                                <img src="{{ asset('uploads/fund-Project/Business-center/' . $item->prove) }}"
