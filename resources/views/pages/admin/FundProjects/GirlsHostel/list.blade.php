<title>Girls Hostel Payment List</title>
                                ...
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="card-title mb-0">
                                            Girls Hostel Cost Estimate List
                                            <span class="badge bg-primary ms-2">{{ $girls_hostel->total() }}</span>
                                        </h5>

                                        <form method="GET" action="{{ route('fundproject.girlsHostel') }}"
                                            ...
                                            <a href="{{ route('fundproject.girlsHostel') }}"
                                    ...
                                    <div class="card-body table-responsive">
                                        <table class="table table-striped table-hover table-sm align-middle">
                                            ...
                                            <tbody>
                                                @forelse($girls_hostel as $index => $item)
                                                    <tr>
                                                        <td>{{ $girls_hostel->firstItem() + $index }}</td>
                                                        ...
                                                        <td>
                                                            @if ($item->prove)
                                                                <img src="{{ asset('uploads/fund-Project/girls-Hostel/' . $item->prove) }}"
