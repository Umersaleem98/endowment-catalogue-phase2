        ...
        <div class="container">
                ...
                <div class="container">
                    <div class="row p-3">
                        ...
                        <p class="text-dark fs-5 mb-4 text-justify" data-aos="fade-right" data-aos-delay="100">
                            ...
                            Resource Mobilization Officers who play a crucial role in executing strategies to secure
                            support
                        ...
                        <p class="text-dark fs-5 mb-4 text-justify" data-aos="fade-right" data-aos-delay="200">
                            ...
                            expertise and networks to promote inclusivity and diversity within the university, ensuring
                            that
                        ...
                        <p class="text-dark fs-5 text-justify" data-aos="fade-right" data-aos-delay="300">
                            <strong>Strengthening Academic and Research Capabilities:</strong> Facilitating partnerships
                            and
            ...
            <div class="row mb-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="col-md-4" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card">
                        <img src="{{ asset('templates/rmo/Danish_Aman.jpeg') }}" alt="Image 1"
                            class="card-img-top custom-img-fluid preview-image">
                    </div>
                </div>
                <div class="col-md-4" data-aos="zoom-in" data-aos-delay="200">
                    <div class="card">
                        <img src="{{ asset('templates/rmo/Zafar_Sultan.jpg') }}" alt="Image 2"
                            class="card-img-top custom-img-fluid preview-image">
                    </div>
                </div>
                <div class="col-md-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="card">
                        <img src="{{ asset('templates/rmo/sidra.jpg') }}" alt="Image 3"
                            class="card-img-top custom-img-fluid preview-image">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="col-md-4" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card">
                        <img src="{{ asset('templates/rmo/sadia_sadat.jpg') }}" alt="Image 4"
                            class="card-img-top custom-img-fluid preview-image">
                    </div>
                </div>
                <div class="col-md-4" data-aos="zoom-in" data-aos-delay="200">
                    <div class="card">
                        <img src="{{ asset('templates/rmo/abc.jpg') }}" alt="Image 5"
                            class="card-img-top custom-img-fluid preview-image">
                    </div>
                </div>
            </div>
