                ...
                <div class="tab-pane fade show active" id="undergraduate" role="tabpanel"
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <form action="{{ route('defult.fulldegree.support.store') }}" method="post"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <form id="ug-non-eng-form" action="{{ route('defult.fulldegree.support.store') }}"
                        ...
                        <div class="col-md-4 mb-2">
                            <form id="ug-custom-form" action="{{ route('custom.fulldegree.support.store') }}"
                                method="post" enctype="multipart/form-data"
                                class="border rounded shadow-sm bg-white">
                                @csrf
                ...
                <div class="tab-pane fade" id="postgraduate" role="tabpanel" aria-labelledby="postgraduate-tab">
                    <div class="row mt-5">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <form id="pg-eng-form" action="{{ route('defult.fulldegree.support.store') }}"
                                method="post" enctype="multipart/form-data"
                                class="mx-3 border rounded shadow-sm bg-white">
                                @csrf
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <form id="pg-non-eng-form" action="{{ route('defult.fulldegree.support.store') }}"
                                method="post" enctype="multipart/form-data"
                                class="border rounded shadow-sm bg-white">
                                @csrf
                        ...
                        <div class="col-md-4 mb-2">
                            <form id="pg-custom-form" action="{{ route('custom.fulldegree.support.store') }}"
                                method="post" enctype="multipart/form-data"
                                class="border rounded shadow-sm bg-white">
                                @csrf
