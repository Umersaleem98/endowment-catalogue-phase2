            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 d-flex justify-content-center">
                        @if (session('success'))
                            <div class="alert alert-success alert-dismissible fade show text-center w-100"
                                role="alert">
                                {{ session('success') }}
                        ...
                        @if (session('error'))
                            <div class="alert alert-danger alert-dismissible fade show text-center w-100"
                                role="alert">
                                {{ session('error') }}
                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2" data-aos="fade-up" data-aos-delay="100">
                        <div class="card" style="background-color: #004476; max-height: 180px;">
                            <div class="card-body">
                                <a href="{{ route('index.support.fulldegree') }}" class="card-link">
                    ...
                    <div class="col-md-6 mb-2" data-aos="fade-up" data-aos-delay="300">
                        <div class="card" style="background-color: #004476; min-height: 175px;">
                            <div class="card-body">
                                <a href="{{ route('annual.support.index') }}" class="card-link">
                                    <div class="icon-container mr-3"><br>
