                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <form action="{{url('default_perpetual_seat')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <input type="text" name="program_type" value="Default-Single-Endowment-UG" class="form-control">
                            ...
                            <form action="{{url('perpetualseatyourname')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="endoement_type" value="single-endowment" hidden>
                                        <div class="form-group">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <form action="{{url('default_perpetual_seat')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" hidden>
                                        ...
                                        <input type="text" name="program_type" value="Default-Circular-Endowment-UG" class="form-control">
                                        <input type="text" name="degree" value="Engineering" class="form-control">
                                        <input type="text" name="seats" value="1" class="form-control">
                                    </div>
                                    <div class="row p-2 mt-4">
                            ...
                            <div class="col-md-4 mb-2">
                                <form action="{{url('perpetualseatyourname')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="program" value="UG" hidden>
                                            <input type="text" name="endoement_type" value="circular-endowment" hidden>
                                            <div class="form-group">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <form action="{{url('default_perpetual_seat')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" hidden>
                                        <label for="pgDegree">Degree:</label>
                                        <input type="text" name="program_type" value="Default-Single-Endowment-PG" class="form-control">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-4 mb-2">
                            ...
                            <form action="{{url('default_perpetual_seat')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group" hidden>
                                    <label for="pgDegree">Degree:</label>
                                    <input type="text" name="program_type" value="Default-Circular-Endowment-PG" class="form-control">
                                    <input type="text" name="degree" value="Postgraduate Engineering" class="form-control">
                                    <input type="text" name="seats" value="1" class="form-control">
                                </div>
                                <div class="row p-2 mt-4">
