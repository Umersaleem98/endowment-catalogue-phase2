                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>
                                    <input type="text" class="form-control" name="description" value="Mosque" required readonly>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td colspan="4">Construction Cost @ 10,500.00/Sft Incl. all services</td>
                                <td>
                                    <input type="number" class="form-control" id="construction_cost" name="construction_cost" value="1589571750.00" readonly>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">Total Project Cost = Rs.</td>
                                <td>
                                    <input type="number" class="form-control" id="total_project_cost" name="total_project_cost" value="1589571750.00" readonly>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">Rs in Million:</td>
                                <td>
                                    <input type="number" class="form-control" id="total_in_million" name="total_in_million" value="1589.57" readonly>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<script>
    document.getElementById('costEstimateForm').addEventListener('input', function () {
        ...
        // Total project cost (assuming it's the same as construction cost)
