...
@endif
    ...
    <div class="row">
        <div class="container">
            ...
            <form action="{{ route('girls.hostel.store') }}" method="POST" id="costEstimateForm" method="post"
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" name="description" 
                                       value="Girls HOSTEL (10 FLOORS)" required readonly>
                            </td>
                            <td>
                                <input type="number" class="form-control" id="area_sft" name="area_sft" 
                                       value="150435.00" step="0.01" required readonly>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="number" class="form-control" id="total_area_sft" name="total_area_sft" 
                                       value="150435.00" readonly readonly>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">Construction Cost @ 10,500.00/Sft Incl. all services = Rs.</td>
                            <td>
                                <input type="number" class="form-control" id="construction_cost" name="construction_cost" 
                                       value="1579567500.00" readonly>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" class="form-control" id="total_in_million" name="total_in_million" 
                                       value="1579.57" readonly>
                            </td>
                        </tr>
                    </tbody>
                </table>
